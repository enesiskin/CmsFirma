					...
					<div class="row pt-xl">
						...
						<div class="col-md-4 col-md-offset-1">
							...
							<ul class="list list-icons list-icons-style-3 mt-xlg mb-xlg">
								...
								<li><i class="fa fa-phone"></i> <strong>Phone:</strong> <?php echo $row_setting['setting_phone'];?></li>
								<li><i class="fa fa-envelope"></i> <strong>Email:</strong> <a href="mailto:<?php echo $row_setting['setting_mail'];?>"><?php echo $row_setting['setting_mail'];?></a></li>
							</ul>
