...
if(isset($_POST['menu_save'])){
  ...
  $run_menu=$conn->prepare("INSERT INTO menu SET menu_name=:menu_name, menu_detail=:detail, menu_no=:menu_no, menu_role =:role, menu_url=:url, menu_submenu=:submenu, category_id=:id");
            ...
            <div class="row">
              <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                  ...
                  <div class="x_content">
                    <!-- Form Start -->
                    <form id="demo-form2" data-parsley-validate class="form-horizontal form-label-left" action="new_menu.php" method="post">
                      ...
                      <div class="form-group">
                        ...
                        <div class="col-md-7 col-sm-7 col-xs-12">
                          <textarea name="menu_detail" class="ckeditor" id="editor1" ></textarea>
                        </div>
                      </div>
                      ...
                      <div class="form-group">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <input id="description" class="form-control col-md-7 col-xs-12" required="required" type="text" name="menu_no" value="0">
                        </div>
                      </div>
                      ...
                      <div class="form-group">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <select class="form-control" name="menu_role" required="required">
                      ...
                      <div class="form-group">
                        <div align="right" class="col-md-6 col-sm-6 col-xs-12 col-md-offset-3">
                          <button type="submit" class="btn btn-success" name="menu_save">Submit</button>
                        </div>
                      </div>
