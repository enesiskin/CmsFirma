            ...
            <div class="row pt-xl">
                ...
                <div class="col-md-9">
                    ...
                    <div class="row">
                        <?php
                        $pagination = 4;
                        $run_pagination =$conn->prepare("SELECT * FROM news");
                        $run_pagination->execute();
                        $all_news = $run_pagination->rowCount();
                        ...
                        $run_news=$conn->prepare("SELECT * FROM news ORDER BY news_time DESC LIMIT $limit,$pagination");
                        $run_news->execute();
                        ...
                        <ul class="pagination">
                            ...
                            while($p < $all_pagination){
                                ...
                                <a href="news.php?pagin=<?php echo $p;?>"><?php echo $p; ?></a></li>
